...
## 5  EXAMPLE INVOCATION FLOW

1. **User** triggers Task 01 with a strategic chain-of-thought prompt.
2. **ServerlessArchitectBot**

  * Saves `session_memory/00_initial_input.md`.
  * Runs Task 01 and stores `01_task_01_output.md` and `01_task_01_decisions.md`.
  * Runs Task 02, then Task 03, each time persisting session memory.
  * Updates `change_log.md` with a new semantic version entry and outputs next steps.
